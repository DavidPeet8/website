	...
	render() {
		return (
			<Helmet htmlAttributes={{ lang: 'en', }}>
				...
				<meta property="og:image" content="https://website.davidpeet.me/images/opengraph.png" />
				<meta property="og:type" content="website" />
				<meta property="og:url" content="https://website.davidpeet.me/" />
				<meta property="og:title" content="David Peet - Software Developer" />
				...
				<title>David Peet - Software Developer</title>
			</Helmet>
		);
	}
}
